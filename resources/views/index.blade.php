...
// });
    ...
    $("#sparkline").sparkline([9,8,8,9,9,7,9,8,7,9,7,8,8,9,9,8,7,8,8,8,8,8,9,7,6,8,1], {
      type: 'line',
      lineColor: '#',
      fillColor: '#2C3038',
      height:'60px',
...
<script>
  var graph = new Rickshaw.Graph({
    ...
    series: [ 
    {
      data: [ { x: 0, y: 11 }, { x: 1, y: 25 }, { x: 2, y: 38 }, { x: 3, y: 30 }, { x: 4, y: 32 }, { x: 5, y: 16 }, { x: 6, y: 16 }, { x: 7, y: 16 }, { x: 8, y: 12 }, { x: 9, y: 12 }, { x: 10, y: 16 }, { x: 11, y: 16 }, { x: 12, y: 19 }, { x: 13, y: 15 }, { x: 14, y: 34 }, { x: 15, y: 16 }, { x: 16, y: 16 }, { x: 17, y: 23 } ],
...
$(document).ready(function(){
  ...
  function sendMessage(){
    ...
    if (text.length > 1) {
      ...
      // }, function(data) {
      //   console.log(data);
      //   $('chat-messages').append('<div class="bubble pull-left">'+text+'<div class="arrow"></div></div>');
      //   $('textarea').val('');
      //   notTyping();
      // });
